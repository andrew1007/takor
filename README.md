...
|any| [IAny](#types) | A function that is `true` for any value |
...
|not.arrayOf| [ListOfMatchers](#types) | The converse [arrayOf](#arrayof) |
|not.is<nolink>| [SingleMatcher](#types) | The converse [is](#is) |
|not.mapOf| [ListOfTupleMatchers](#types) | The converse [mapOf](#mapof) |
|not.oneOf| [ListOfMatchers](#types) | The converse [oneOf](#oneof) |
|not.setOf| [ListOfMatchers](#types) | The converse [setOf](#setof) |
|not.shape| [ShapeOfMatchers](#types) | The converse [shape](#shape) |
